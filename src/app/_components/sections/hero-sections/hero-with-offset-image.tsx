      ...
      >
        ...
        <div className="mx-auto max-w-7xl px-6 py-32 sm:py-40 lg:px-8">
          <div className="mx-auto max-w-2xl lg:mx-0 lg:grid lg:max-w-none grid-flow-col lg:gap-x-16 lg:gap-y-6 grid-rows-1 xl:gap-x-8">
            ...
            >
              Revolutionizing Car Care: Where Shine Meets Precision
            </h1>
            <div className="mt-6 max-w-xl lg:mt-0 col-end-1 row-start-1">
              ...
              >
                Experience the ultimate in automotive detailing with our unparalleled car wash services, designed to give your vehicle a showroom finish every time.
              </p>
